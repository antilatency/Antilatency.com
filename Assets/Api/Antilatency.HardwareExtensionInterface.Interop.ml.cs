	...
	public sealed partial class Antilatency : Scope {
		public sealed partial class HardwareExtensionInterface : Scope {
			public sealed partial class Interop : Scope {
				...
				public static Material Material => new Material("Antilatency.HardwareExtensionInterface.Interop",null,$"Namespace in `{Api.Antilatency.HardwareExtensionInterface._FullNameRef}`")[new Section("Types")
					[new UnorderedList()
						[$"*enum* `{PinState._NameRef}`"]
						[$"*enum* `{Pins._NameRef}`"]
