			...
			public sealed partial class Tasks : Scope {
				public sealed partial class Tests : Scope {
					public sealed partial class Sync : Scope {
						...
						public static Material Material => new Material("Antilatency.DeviceNetwork.Tasks.Tests.Sync",null,$"Namespace in `{Api.Antilatency.DeviceNetwork.Tasks.Tests._FullNameRef}`")[new Section("Types")
							[new UnorderedList()
						...
						public sealed partial class IHostToDevice : Scope {
							...
							public sealed partial class Methods : Scope {
								public sealed partial class ack : Scope {
									...
									public static Material Material => new Material("Antilatency.DeviceNetwork.Tasks.Tests.Sync.IHostToDevice.ack",null,$"Method of `{Type(Api.Antilatency.DeviceNetwork.Tasks.Tests.Sync.IHostToDevice._NameRef)}`\n`{RawDeclarationCode}`")
						...
						public sealed partial class IDeviceToHost : Scope {
							...
							public sealed partial class Methods : Scope {
								public sealed partial class ack : Scope {
									...
									public static IElement CodeInline => CodeInline(RawDeclarationCode);
									public static IElement RawDeclarationCode => new Text($"{Keyword("void")} {_NameRef}()");
									public static Material Material => new Material("Antilatency.DeviceNetwork.Tasks.Tests.Sync.IDeviceToHost.ack",null,$"Method of `{Type(Api.Antilatency.DeviceNetwork.Tasks.Tests.Sync.IDeviceToHost._NameRef)}`\n`{RawDeclarationCode}`")
										[new Section("Parameters")]
										;
									public sealed partial class Parameters : Scope {
									} //scope Parameters
