	...
	public sealed partial class Antilatency : Scope {
		public sealed partial class DeviceNetwork : Scope {
			public sealed partial class Sniffer : Scope {
				...
				public static Material Material => new Material("Antilatency.DeviceNetwork.Sniffer",null,$"Namespace in `{Api.Antilatency.DeviceNetwork._FullNameRef}`")[new Section("Types")
					[new UnorderedList()
						[$"*interface* `{ISniffer._NameRef}`"]
						[$"*interface* `{ISnifferable._NameRef}`"]
					]
				];
				public sealed partial class ISniffer : Scope {
					...
					public sealed partial class Methods : Scope {
						public sealed partial class onDeviceConnected : Scope {
							...
							public static Material Material => new Material("Antilatency.DeviceNetwork.Sniffer.ISniffer.onDeviceConnected",null,$"Method of `{Type(Api.Antilatency.DeviceNetwork.Sniffer.ISniffer._NameRef)}`\n`{RawDeclarationCode}`")
						...
						public sealed partial class onDeviceDisconnected : Scope {
							...
							public static Material Material => new Material("Antilatency.DeviceNetwork.Sniffer.ISniffer.onDeviceDisconnected",null,$"Method of `{Type(Api.Antilatency.DeviceNetwork.Sniffer.ISniffer._NameRef)}`\n`{RawDeclarationCode}`")
								[new Section("Parameters")]
								;
							public sealed partial class Parameters : Scope {
								public sealed partial class id : Scope {
						...
						public sealed partial class onDataRx : Scope {
							...
							public static Material Material => new Material("Antilatency.DeviceNetwork.Sniffer.ISniffer.onDataRx",null,$"Method of `{Type(Api.Antilatency.DeviceNetwork.Sniffer.ISniffer._NameRef)}`\n`{RawDeclarationCode}`")
								[new Section("Parameters")]
								;
							public sealed partial class Parameters : Scope {
								public sealed partial class id : Scope {
						...
						public sealed partial class onDataTx : Scope {
							...
							public static IElement CodeInline => CodeInline(RawDeclarationCode);
							public static IElement RawDeclarationCode => new Text($"{Keyword("void")} {_NameRef}({Parameters.id.RawDeclarationCode}, {Parameters.data.RawDeclarationCode}, {Parameters.size.RawDeclarationCode})");
							public static Material Material => new Material("Antilatency.DeviceNetwork.Sniffer.ISniffer.onDataTx",null,$"Method of `{Type(Api.Antilatency.DeviceNetwork.Sniffer.ISniffer._NameRef)}`\n`{RawDeclarationCode}`")
								[new Section("Parameters")]
								;
							public sealed partial class Parameters : Scope {
								public sealed partial class id : Scope {
				...
				public sealed partial class ISnifferable : Scope {
					...
					public sealed partial class Methods : Scope {
						public sealed partial class setSniffer : Scope {
							...
							public static Material Material => new Material("Antilatency.DeviceNetwork.Sniffer.ISnifferable.setSniffer",null,$"Method of `{Type(Api.Antilatency.DeviceNetwork.Sniffer.ISnifferable._NameRef)}`\n`{RawDeclarationCode}`")
								[new Section("Parameters")]
								;
							public sealed partial class Parameters : Scope {
								public sealed partial class sniffer : Scope {
									public static IElement CodeBlock => CodeBlock(RawDeclarationCode);
									public static IElement CodeInline => CodeInline(RawDeclarationCode);
									public static IElement RawDeclarationCode => new Text($"{Type(Api.Antilatency.DeviceNetwork.Sniffer.ISniffer._NameRef)} {_Name}");
