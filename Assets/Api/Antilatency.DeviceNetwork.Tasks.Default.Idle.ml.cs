			...
			public sealed partial class Tasks : Scope {
				public sealed partial class Default : Scope {
					public sealed partial class Idle : Scope {
						public static IElement _NameRef => new Deferred(()=>Material).Modify().ContentReplace($"Idle").AddClasses("Namespace");
						...
						public static Material Material => new Material("Antilatency.DeviceNetwork.Tasks.Default.Idle",null,$"Namespace in `{Api.Antilatency.DeviceNetwork.Tasks.Default._FullNameRef}`")
							[new Section("Types")
								[new UnorderedList()
