    ...
    public static Material SocketCustomizing_ru =>
        ...
        $"Как разработать свой {Terms.Socket} на основе {Terms.SocketReferenceDesign}")
            ...
            [new Section("Разработка платы")
                ...
                [$"Расположение nRF модуля должно соответствовать требованиям технического описания. Особое внимание обратите на рекомендации к расположению антенны."]
                [$"*Для загрузки доступны файлы:* схемотехника, пример трассировки, 3d модель, производственные BOM, Gerber и техническое описание для модуля nRF52840."]
                [CustomMaterials]
            ]
