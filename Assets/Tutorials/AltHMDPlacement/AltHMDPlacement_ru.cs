...
partial class Tutorials : Scope {
    ...
    public static Material Alt_HMD_Placement_ru => new Material("Расположение трекера на VR гарнитуре",
     ...
     [$"Неправильное, даже на несколько градусов, расположение может вызвать у пользователя дискомфорт и тошноту."]
     ...
     [$"Мы подготовили инструкцию и предустановки в {Software.Antilatency_Service} для популярных VR Гарнитур. Найдите нужную гарнитуру ниже или воспользуйтесь инструкцияей по установке расположения трекера вручную."]
     ...
     [new Section("Установка трекера на OculusQuest")
      ...
      [new Section("Установка трекера на VivePro")
        ...
        [$"Если вы используете проприетарный {Hardware.PicoG2Socket}, подключите его к разъему и выберите _PicoGoblin2_"]
      ]
      ...
      [$"1. Откройте вкладку _Placement_ в {Software.Antilatency_Service}. Нажмите на синий значок в правом нижнем углу экрана и выберите _Custom_"]
      [ASSelect]
