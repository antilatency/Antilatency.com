...
partial class Tutorials : Scope {
    ...
    public static Material Alt_HMD_Placement_ru => new Material("Расположение трекера на VR гарнитуре",
     ...
     [$"Мы подготовили инструкцию и предустановки в {Software.Antilatency_Service} для популярных VR Гарнитур. Найдите нужную гарнитуру ниже или воспользуйтесь инструкцией по установке расположения трекера вручную."]
