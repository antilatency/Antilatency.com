...
partial class Tutorials : Scope {
    ...
    [$"3. Откройте {Software.Antilatency_Service}, вкладку Device Network"]
    [DeviceTreeAS]

    [$"4. Выберите {Hardware.Tag} в {Terms.Device_Tree}. Во вкладке справа назначьте нужное свойство _Tag_ (в нашем случае _Gun_). После ввода нового свойства слева от него появится значок желтой ручки."]
    [SetProperty]
