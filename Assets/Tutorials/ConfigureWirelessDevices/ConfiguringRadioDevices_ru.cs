...
partial class Tutorials {
    ...
    [$"Все устройства Antilatency, в зависимости от их роли в системе {Terms.Antilatency_Radio_Protocol}, можно разделить на две группы: "]
      ...
      [new Section("Восстановление связи с клиентом")
            ...
            [new UnorderedList()
            [$"Свойство `MasterSN` содержит серийный номер неизвестной точки доступа или устройства, которого нет в наличии. В таком случае, можно {new ExternalReference("#ResetMaster", "сбросить MasterSN")} с помощью кнопки питания."]                    
       ...
       [new Section("Как сбросить свойство MasterSN", "ResetMaster") 
        ...
        [new UnorderedList()
                ...
                [@$"*c помощью кнопки питания устройства* {new OrderedList()
                    [$"Подключите точку доступа к Host."]
                    [$"Включите клиент и дождитесь, пока он подключится к точке доступа. Светодиоды обоих устройств начнут равномерно мигать одним и тем же цветом."]
