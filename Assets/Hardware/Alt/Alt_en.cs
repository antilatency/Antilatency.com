...
partial class Hardware : Scope {
        ...
        @$"{Hardware.Alt} is an optical inertial tracking module. {Hardware.Alt} is located on objects being tracked and determines their position in space in relation to infrared markers. 
