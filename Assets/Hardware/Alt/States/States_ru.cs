...
partial class Hardware : Scope {
    ...
    public static Material AltStates_ru => new Material("Состояния Alt", null, $"Возможные состояния {Alt}")
        ...
        [new Section("Состояние ошибки")
            [$"{Hardware.Alt} может войти в состояние ошибки в случае выхода из строя электронных компонентов, отсутствия конфигурационных данных, ошибки в прошивке или неправильного использования."]
