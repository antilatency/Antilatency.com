...
partial class Hardware : Scope {
    partial class AltDescription : Scope {
        ...
        [new Section("Состояние ошибки")
            ...
            [$"Ошибка выводится в виде повторяющейся серии цветных пульсов светодиода с паузой в две секунды между циклами."]
            [@$"`Номер пульса` обозначает номер подсистемы, в которой произошла ошибка. 
            `Цвет пульса` - номер ошибки внутри подсистемы."]
            ...
            [new Info($"Код ошибки #0 сигнализирует об отсутствии ошибки.")]
        ]
