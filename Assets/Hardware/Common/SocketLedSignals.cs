...
partial class Hardware : Scope {
    ...
    public static LedSignal RadioSocketSearchLedSignal_ru = new LedSignal($"{new ColorSequence()[System.Drawing.Color.Green, 1f][System.Drawing.Color.Blue,1f][System.Drawing.Color.Green, 1f][System.Drawing.Color.Blue,1f]}", $"Устройство ищет свободный радиоканал или заданный для этого устройства радиоканал занят другим.");
