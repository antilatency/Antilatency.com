...
partial class Hardware : Scope {
    ...
    public static Material ExtensionBoard_ru =>
        ...
        [new Section("Pinout")
            ...
            [$"*Todo table*"]
            [$"*Todo warning* Максимальное напряжение на всех пинах(в том числе и аналоговых) не более 3В."]
            [$"*Todo warning* IOA_3 и IOA_4 - низкоскоростные пины.(Частота сигнала не должна превышать 10kHz)"]]
        ...
        [new Section("Output")
            ...
            [$"*Todo Info* Ток, потребляемый с пина, не должен превышать 4mA."]
        ...
        [new Section("Analog")
            ...
            [$"*Todo Info* Резистор R3 обеспечивает ограничение напряжение на пине IOA. Напряжение должно быть в диапазоне 0-3 В."]]
            ;
}