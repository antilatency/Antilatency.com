...
partial class Hardware : Scope {
    ...
    public static Material ExtensionBoard_en =>
        ...
        [new Section("Pinout")
            ...
            [$"*Todo table*"]
            [$"*Todo warning* The maximum voltage on all pins (including the analog ones) is 3V."]
            [$"*Todo warning* IOA_3 and IOA_4 are low-speed pins. (The signal frequency should not exceed 10kHz)"]]
        ...
        [new Section("Output")
            ...
            [$"*Todo Info* The current consumption from the pin must not exceed 4mA."]
        ...
        [new Section("Analog")
            ...
            [$"*Todo Info* An R3 resistor provides a voltage limitation on the IOA pin. The voltage should be in the range of 0-3 V."]]
            ;
}