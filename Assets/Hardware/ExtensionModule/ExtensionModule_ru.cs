...
partial class Hardware {
    ...
    null,
    $" Модуль для подключения к {Hardware.HMD_Radio_Socket} дополнительных компонентов. С его помощью можно, например, считывать внешние триггеры с кнопок или управлять виброоткликом устройства через встроенный вибромоторчик.")
