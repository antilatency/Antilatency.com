...
partial class Terms {
    ...
    [$"Socket может работать в одном из двух режимов: как точка доступа или как клиент. Подробнее о режимах работы читайте тут: {Tutorials.ConfiguringRadioDevices}"]
