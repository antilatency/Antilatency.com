...
partial class Terms : Scope {
    ...
    $"Accessing the GPIO of a socket through a USB type C connector with {Hardware.ExtensionBoard} and {Software.AntilatencyHardwareExtensionInterface}")
        ...
        [$"*Todo info* {Hardware.ExtensionBoard} is not symmetrical, You should connect the board from the right side. The power connector is placed below the blue connectors (see the scheme above)."]
    ;   
