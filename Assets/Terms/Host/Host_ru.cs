...
[$"{Terms.Host} - корневой узел {Terms.Device_Tree}, сети, объединяющей все устройства, подключённые к одному Host. Роль Host может выполнять, например, компьютер, шлем виртуальной реальности или VR станция. На Host-устройстве вы можете запускать приложения, задействующие устройства Antilatency."]
