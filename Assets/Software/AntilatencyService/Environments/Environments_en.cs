            ...
            [new Section("How to add the Environment","")
                ...
                [$"Use the \"*from link*\" option to add a new tracking area. Here you can edit the name of the Environment."]
                   [new Note($"Copy the link in advance to automatically fill in the form with data from the clipboard.")]
                      ...
                      [new Section("If you use an Android device")

                        [$"*\nAdd with AntilatencyService*"]
                        ...
                        [$"*\nAdd with {new ExternalReference("https://developer.android.com/studio/command-line/adb", "adb")}*"] 
       
                                [$"To add a new Environment write `adb shell am start` and add the link after it. Here is an example request:"]
